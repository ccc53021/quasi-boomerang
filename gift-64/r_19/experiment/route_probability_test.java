...
//		String difference_k_delta_2 = "0x04000000200000000000000000100000";
		...
		// p = 2^-14.0 * 1 = 0.00006103515 = 2^-14.0
		int upper_experiment_time = (int) Math.pow(2, 16);
		// p = 0.0546875 = 2^-4.192645077942396
		int em_experiment_time = (int) Math.pow(2, 16);
		// p = 2^-11.0 * 1 = 0.00048828125 = 2^-11.0
		int lower_experiment_time = (int) Math.pow(2, 16);
