...
def get_quasidifferentials_by_one_fixed_input_and_output(diff_route, route_number, min_weight, max_weight):
    def search_differential(f):
        ...
        set_fixed_difference(u0_a[differential_characteristic_rounds_upper], 0x0)
        set_fixed_difference(u1_a[differential_characteristic_rounds_upper], 0x0)
            ...
            while True:
                ...
                if r == btor.SAT:
                    ...
                    print("     [0x{:016x}, 0x{:016x}, 0x{:016x}],".format(u0_a_final, diff_route[
                        3 * (differential_characteristic_rounds_upper)], u1_a_final),
                          file=f)
