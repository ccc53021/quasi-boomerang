            ...
            while True:
                ...
                if r == btor.SAT:
                    ...
                    for i in range(differential_characteristic_rounds_lower):
                        ...
                        if i == 0:
                            print("     # upper: {}".format(int(cost_lower.assignment, base=2)), file=f)
                    ...
                    print("", file=f)
                    print("     [0x{:016x}, 0x{:016x}, 0x{:016x}],".format(route_mask[3 * (differential_characteristic_rounds_lower)],
                                                                           u1_a_final, route_diff[3 * (differential_characteristic_rounds_lower)]),
                          file=f)
