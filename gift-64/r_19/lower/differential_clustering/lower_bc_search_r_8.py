...
def get_routes_by_one_fixed_input_and_output(min_weight, max_weight, input_difference, output_difference, diff_k):
    ...
    filename = "result/lower_bc_search_lower_{}_w_{}_to_{}.txt".format(differential_characteristic_rounds_lower, min_weight, max_weight)
    f = open(filename, "w")
...
upper_input_difference = 0x0a00000000000000
# lower_output_difference = 0x0800000000000000
lower_output_difference = 0x0800000000000010
