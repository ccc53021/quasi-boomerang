...
def compute_sign(route_u0, route_u1, diff_route, round_lower):
    correlation_sign = 0
                ...
                if r == btor.SAT:
                    ...
                    for i in range(differential_characteristic_rounds_lower):
                        ...
                        if i < differential_characteristic_rounds_lower:
                            if i == 0:
                                print("     # lower: {}".format(int(cost_upper.assignment, base=2)), file=f)
                    ...
                    u0_a_final = int(u0_a[
                                         differential_characteristic_rounds_lower].assignment,
                                     base=2)
                    u1_a_final = int(u1_a[
                                         differential_characteristic_rounds_lower].assignment,
                                     base=2)
                    ...
                    print("     [0x{:016x}, 0x{:016x}, 0x{:016x}],".format(u0_a_final, u1_a_final, diff_route[
                        4 * (differential_characteristic_rounds_lower)]),
                          file=f)
                    route_u0.append(u0_a_final)
                    route_u1.append(u1_a_final)
                    # route_u2.append(u2_a_final)

                    s_route = compute_sign(route_u0, route_u1, diff_route, differential_characteristic_rounds_lower)
                    if s_route < 0:
                        count_negative += 1
                        # print("    # sign = -1,", file=f)
                    else:
