...
import quasidifferential.application.related_key.boomerang_v2.skinny_64.skinny_64_128.experiment.round_key_generating;
...
public class route_probability_test {
	...
	public static void main(String[] args) {
		...
		// p = 2^-6.0 * 3 = 0.046875 = 2^-4.415037499278844
		int upper_experiment_time = (int) Math.pow(2, 20);
		// p = 2^-2 = 0.25
		int em_experiment_time = (int) Math.pow(2, 20);
		// 0-th: p = 0;
		// 1-st: 2^-18.0 * 32 = 0.0001220703125 = 2^-13.0;
		// 2-nd: p = 2^-18.0 * 8 = 3.0517578125e-05 = 2^-15.0;
		// 4-th: p = 2^-18.0 * 8 = 3.0517578125e-05 = 2^-15.0
