...
def key_conditions_by_one_trail(iii, diff_and_trail, round_upper):
    ...
    correlation = 1
    for round in range(round_upper):
        # sb
        ...
        for i in range(8):
            ...
            for j in range(sbox_bits):
                ...
                if bb_x == 1:
                    if tk_number == 1:
                        pp_tk1_list = tk1s_64[round][i * sbox_bits + j]
                        ...
                        for pp in pp_tk1_list:
                            one_key_expression_tk1[pp] ^= 1
                        pp_tk2_list = tk2s_64[round][i * sbox_bits + j]
                        ...
                        for pp in pp_tk2_list:
                            one_key_expression_tk2[pp] ^= 1
                        pp_tk3_list = tk3s_64[round][i * sbox_bits + j]
    ...
    for ww in range(max_w):
        ...
        if len(dts_w) > 0:
            ...
            for i in range(len(dts_w)):
                ...
                one_key_expression, one_key_expression1, key_str = key_conditions_by_one_trail(i + 1, one_quasi_bc, round_upper)
