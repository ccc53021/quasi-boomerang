package quasidifferential.boomerang.skinny_64.skinny_64_192.experiment;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;
import java.util.Random;
import quasidifferential.application.related_key.boomerang_v2.skinny_64.skinny_64_192.experiment.round_key_generating;

public class route_probability_test {
	...
	public static void main(String[] args) {
		...
		int encrypt_round = 22;

		int upper_round_upper = 10;
		int[] upper_input_difference = get_a_characteristic_1d_by_str("0x0100100000010020");
		int[] upper_output_difference = get_a_characteristic_1d_by_str("0x0040004000000040");

		int em_begin_round = 10;
		int em_round_upper = 1;
		int em_round_lower = 1;
		int[] em_input_difference = get_a_characteristic_1d_by_str("0x0040004000000040");
		int[] em_output_difference = get_a_characteristic_1d_by_str("0x00b0000000000000");

		int lower_begin_round = 10 + 1 + 1;
		int lower_round_lower = 10;
		int[] lower_input_difference = get_a_characteristic_1d_by_str("0x00b0000000000000");
		int[] lower_output_difference = get_a_characteristic_1d_by_str("0x2020250000202022");
		
		int[][][] tk_constraints = new int[][][] {};
		int[] tk_values = new int[] {};
		...
		String difference_tk1_delta_1 = "0x00000000000000a0";
		String difference_tk1_delta_2 = "0x00000a0000000000";
		String difference_tk2_delta_1 = "0x0000000000000020";
		String difference_tk2_delta_2 = "0x0000070000000000";
		String difference_tk3_delta_1 = "0x00000000000000d0";
		String difference_tk3_delta_2 = "0x00000e0000000000";
		...
		int[] tk3_2 = get_another_key_by_k_and_difference(get_a_difference_1d(difference_tk3_delta_1), tk3_1);
		int[] tk3_3 = get_another_key_by_k_and_difference(get_a_difference_1d(difference_tk3_delta_2), tk3_1);
		int[] tk3_4 = get_another_key_by_k_and_difference(get_a_difference_by_two_states(get_a_difference_1d(difference_tk3_delta_1), get_a_difference_1d(difference_tk3_delta_2)), tk3_1);
 
		System.out.println("--------------- generating rks ---------------------");
		int[][][] round_tk1s = get_round_tks_by_initial_tk1_and_tk2_and_tk3(tk1_1, tk2_1, tk3_1, encrypt_round);
		int[][] round_tk1_1 = round_tk1s[0];
		int[][] round_tk2_1 = round_tk1s[1];
		int[][] round_tk3_1 = round_tk1s[2];
		int[][][] round_tk2s = get_round_tks_by_initial_tk1_and_tk2_and_tk3(tk1_2, tk2_2, tk3_2, encrypt_round);
		int[][] round_tk1_2 = round_tk2s[0];
		int[][] round_tk2_2 = round_tk2s[1];
		int[][] round_tk3_2 = round_tk2s[2];
		int[][][] round_tk3s = get_round_tks_by_initial_tk1_and_tk2_and_tk3(tk1_3, tk2_3, tk3_3, encrypt_round);
		int[][] round_tk1_3 = round_tk3s[0];
		int[][] round_tk2_3 = round_tk3s[1];
		int[][] round_tk3_3 = round_tk3s[2];
		int[][][] round_tk4s = get_round_tks_by_initial_tk1_and_tk2_and_tk3(tk1_4, tk2_4, tk3_4, encrypt_round);
		int[][] round_tk1_4 = round_tk4s[0];
		int[][] round_tk2_4 = round_tk4s[1];
		int[][] round_tk3_4 = round_tk4s[2];
		...
		round_tk3[0] = round_tk3_1;
		round_tk3[1] = round_tk3_2;
		round_tk3[2] = round_tk3_3;
		round_tk3[3] = round_tk3_4;
		
		System.out.println("------------------------ experiment ------------------");
		// p = 2^-14.0 * 1 + 2^-15.0 * 5 + 2^-16.0 * 4 = 0.000274658203125 = 2^-11.830074998557688
		int upper_experiment_time = (int) Math.pow(2, 20);
		// p = 2^-16*512 + 2^-17*768 + 2^-18*2304 + 2^-19*3072 + 2^-20*1024 = 0.029296875 = = 2^-5.093109404391481
		int em_experiment_time = (int) Math.pow(2, 20);
		// p = 2^-12.0 * 2 + 2^-13.0 * 6 + 2^-14.0 * 6 + 2^-15.0 * 2 = 0.00164794921875 = 2^-9.245112497836532
		int lower_experiment_time = (int) Math.pow(2, 20);
...
//	public static int [][][] tk3s_64 = round_key_generating.tk3s_64;
	...
	public static int[][][] get_round_tks_by_initial_tk1_and_tk2_and_tk3(int[] initial_tk1, int[] initial_tk2, int[] initial_tk3, int round) {
		int[][] round_tk1s = new int[round][];
		int[][] round_tk2s = new int[round][];
		int[][] round_tk3s = new int[round][];
		...
		for(int r = 0; r < round; r++) {
			if (tk_number == 1) {
				...
				int[][] bits_tk3 = round_key_generating.tk3s_64[r];
				int[] rk3 = new int[bits_tk3.length];
				for(int i = 0; i < bits_tk3.length; i++) {
					int temp = 0;
					int[] one_i = bits_tk3[i];
					for(int ii = 0; ii < one_i.length; ii++) {
						int kk3 = one_i[ii];
		...
		int[][][] round_tks = new int[3][][];
		round_tks[0] = round_tk1s;
		round_tks[1] = round_tk2s;
		round_tks[2] = round_tk3s;
	...
	public static void one_experiment_amplified_upper(int[] input_difference, int[] output_difference, int number, int experiment_time, int[] sbox, int[] sbox_inverse, int[] lbox, int[] lbox_inverse, List sr_bits_table, List sr_inverse_table, int[][][] round_tk1, int[][][] round_tk2, int[][][] round_tk3, int round_upper) {
		...
		for(int et = 0; et < experiment_time; et++) {
			...
			int[] diff_y = get_a_difference_by_two_states(y, y1);
	...
	public static void one_experiment_amplified_lower(int[] input_difference, int[] output_difference, int number, int experiment_time, int[] sbox, int[] sbox_inverse, int[] lbox, int[] lbox_inverse, List sr_bits_table, List sr_inverse_table, int[][][] round_tk1, int[][][] round_tk2, int[][][] round_tk3, int begin_round, int round_lower) {
		int count_rp = 0;
		for(int et = 0; et < experiment_time; et++) {
			int[][] x_and_x1 = get_an_random_plaintext_and_another_by_difference(input_difference);
			int[] x = x_and_x1[0];
